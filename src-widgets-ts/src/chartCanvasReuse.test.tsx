...
// Every name the module imports has to be here, or the ESM import of a missing export throws. The
// recorder deliberately has no static `register`, so the guarded Chart.register() call is skipped.
vi.mock('chart.js', () => ({
    Chart: ChartMock,
