...
export default class MaterialDesignInstalledVersion extends VisWidget {
    ...
    static getWidgetInfo(): RxWidgetInfo { return { ...createInfo('tplVis2-materialdesign-Installed-Version', 'Installed Version', [{ name: 'common', fields: [{ name: 'debug', label: 'debug', type: 'checkbox' }] }]), visPrev: squarePreview('F02FD'), visDefaultStyle: { width: 120, height: 20 } }; }
    ...
    // Material 3 (../../MATERIAL3_PLAN.md): the two pills are the whole widget, so M3 mode only swaps
    // their hard-coded grey/green for the surface and primary role pairs — geometry stays legacy.
