...
export default class MaterialDesignInstalledVersion extends VisWidget {
    ...
    static getWidgetInfo(): RxWidgetInfo { return { ...createInfo('tplVis2-materialdesign-Installed-Version', 'Installed Version', [{ name: 'common', fields: [] }]), visPrev: squarePreview('F02FD'), visDefaultStyle: { width: 120, height: 20 } }; }
