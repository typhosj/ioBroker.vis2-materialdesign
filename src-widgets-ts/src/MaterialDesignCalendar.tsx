...
import { squarePreview, RenderProps, VisWidget, createInfo, sizeCss, stateValue, formatMoment, boolValue as b, numberValue as n, textValue } from './widgetUtils';
...
export const calendarEventOccursOnDate = (event: Event, date: string): boolean => {
    ...
    // midnight of the following day, which is the same exclusive boundary. Equal start/end stays a
    // one-day fallback.
...
export default class MaterialDesignCalendar extends VisWidget {
    ...
    renderWidgetBody(props: RenderProps): React.JSX.Element {
        ...
        const dayBackground = s(d.calendarDayBackgroundColor, isDark ? '#303030' : '#fff');
        const headerBackground = s(d.calendarHeaderBackground, isDark ? '#303030' : '#fff');
